        ...
        <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
          <div>
            ...
            <p className="page-subtitle mt-3 max-w-2xl">
              Search and discover all available courses from your learning
              platform.
            </p>
          </div>
          ...
          <form
            ...
            className="relative flex w-full items-center gap-3 lg:max-w-md"
          >
            <Search
              size={17}
            ...
            <input
              ...
              className="h-12 w-full rounded-xl border border-slate-700/75 bg-slate-950/45 pl-10 pr-4 text-sm text-slate-100 outline-none transition-all placeholder:text-slate-600 focus:border-indigo-400/70 focus:ring-4 focus:ring-indigo-500/10"
            />
